...
export type AgentStatus = "idle" | "queued" | "running" | "blocked" | "completed" | "failed";
export type ArtifactStatus = "draft" | "validated" | "rejected" | "approved";
...
export interface GraphicalAbstract {
  ...
  title: string;
  message: string;
  layout: "landscape-three-panel" | "pipeline" | "mechanism-map";
  prompt: string;
  caption: string;
  altText: string;
